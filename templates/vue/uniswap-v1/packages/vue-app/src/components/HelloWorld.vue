<template>
  <div class="hello">
    ...
    <h3>Learn Uniswap v1</h3>
    <ul>
      <li>
        <a href="https://uniswap.org/docs/v1/" target="_blank" rel="noopener">Core Docs</a>
      </li>
      <li>
        <a href="https://discord.gg/Y7TF6QA" target="_blank" rel="noopener">Community Chat</a>
      </li>
      <li>
        <a href="https://twitter.com/uniswapprotocol" target="_blank" rel="noopener">Twitter</a>
      </li>
    </ul>
  </div>
</template>
...
export default {
  ...
  async mounted() {
    try {
      const { data, loading, stale } = await this.$apollo.query({ query: GET_EXCHANGES });
