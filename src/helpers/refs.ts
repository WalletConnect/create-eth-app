...
export function getRefs(): { ref: string; tarGzRef: string } {
  ...
  // If the program is run in development mode, we source the templates from a
  // development ref. In production, we use the current version of the package
  // prepended by the letter "v".
